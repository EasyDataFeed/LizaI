...
using Databox.Libs.ScraperEbayApi;
using ScraperEbayApi.Helpers;
using ScraperEbayApi.Enums;
using ScraperEbayApi.DataItems;
using System.Xml;
using ScraperEbayApi.Extensions;

namespace WheelsScraper
{
    public class ScraperEbayApi : BaseScraper
    {
        #region constants
        ...
        public ScraperEbayApi()
        {
            Name = "ScraperEbayApi";
            Url = "https://www.ScraperEbayApi.com/";
            PageRetriever.Referer = Url;
            WareInfoList = new List<ExtWareInfo>();
            Wares.Clear();

            Complete += ScraperEbayApi_Complete;

            SpecialSettings = new ExtSettings();
        }

        private void ScraperEbayApi_Complete(object sender, EventArgs e)
        {
        ...
        {
            EbayApiIdKeys.Clear();
            EbayApiIdKeys.Add(extSett.Key, false);
