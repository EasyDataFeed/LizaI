...
using EbayNewParts;
using Databox.Libs.EbayNewParts;
using EbayNewParts.DataItems;
using EbayNewParts.Enums;
...
{
    public class EbayNewParts : BaseScraper
    {
        ...
        {
            Name = "EbayNewParts";
            Url = "https://www.EbayNewParts.com/";
            PageRetriever.Referer = Url;
            WareInfoList = new List<ExtWareInfo>();
            Wares.Clear();
            BrandItemType = 2;

            Complete += EbayNewParts_Complete;

            SpecialSettings = new ExtSettings();
        }

        private void EbayNewParts_Complete(object sender, EventArgs e)
        {
            if (extSett.FlgScrap)
            {
                ...
                MessagePrinter.PrintMessage(FTP_UPLOADING);
                ...
                if (!string.IsNullOrEmpty(url))
                {
                    ...
                    MessagePrinter.PrintMessage(FTP_UPLOADED + ": " + urlForBatch);

                    // MessagePrinter.PrintMessage($"Url for file on FTP - {urlForBatch}");

                }
                else
                {
                    MessagePrinter.PrintMessage($"File not upload to FTP");
                }
                    ...
                    if (!string.IsNullOrEmpty(storeId))
                    {
                        ...
                        lock (this)
                        {
                            lstProcessQueue.Add(new ProcessQueueItem()
                            {
                                ...
                                //URL = $"https://www.ebay.com/sch/m.html?_nkw=&_armrs=1&_from=&_mPrRngCbx=1&_udlo=0&_udhi=&_ssn={storeId}&_ipg=200&rt=nc",
                                //URL = $"https://www.ebay.com/sch/m.html?_nkw=&_armrs=1&_from=&_ssn={storeId}&_ipg=200&rt=nc",
                    ...
                    if (countItems < 10000 && countItems != 0)
                    {
                        lock (this)
                        {
                            lstProcessQueue.Add(new ProcessQueueItem()
                            {
                                ...
                                //URL = $"https://www.ebay.com/sch/m.html?_nkw=&_armrs=1&_from=&_ssn={pqi.Name}&_ipg=200&rt=nc",
                    ...
                    else
                    {
                        ...
                        lock (this)
                        {
                            lstProcessQueue.Add(new ProcessQueueItem()
                            {
                                ...
                                //URL = $"https://www.ebay.com/sch/m.html?_nkw=&_armrs=1&_from=&_mPrRngCbx=1&_udlo=0&_udhi=50&_ssn={pqi.Name}&_ipg=200&rt=nc",
        ...
        private void ProcessPagePriceFilter(ProcessQueueItem pqi)
        {
            ...
            try
            {
                //string lastCheckUrl = "https://www.ebay.com/sch/m.html?_nkw=&_armrs=1&_from=&_mPrRngCbx=1&_udlo=100000&_udhi=&_ssn=qeautoparts1&_ipg=200&rt=nc";
                //string testUrl = "https://www.ebay.com/sch/m.html?_nkw=&_armrs=1&_from=&_mPrRngCbx=1&_udlo=10000&_udhi=20000&_ssn=qeautoparts1&_ipg=200&rt=nc";

                // pqi.URL = "https://www.ebay.com/sch/shopeddies/m.html?_nkw&_armrs=1&_from&_mPrRngCbx=1&_udlo=16&_udhi=17&_sop=10&_ipg=200&rt=nc";


                Thread.Sleep(3000);
                //var html = PageRetriever.ReadFromServer(lastCheckUrl, true);
                var html = PageRetriever.ReadFromServer(pqi.URL, true);
                var htmlDoc = new HtmlDocument();
                html = HttpUtility.HtmlDecode(html);
                htmlDoc.LoadHtml(html);
                ...
                //transportItem.CurrentMaxPrice = 17;
                //transportItem.CurrentMinPrice = 16;
                ...
                else
                {
                    if ((countItems < 10000 && countItems != 0) || transportItem.CurrentMinPrice == transportItem.CurrentMaxPrice)
                    {
                        ...
                        else
                        {
                            lock (this)
                            {
                                ...
                                {
                                    ItemType = (int)ItemType.ProcessingStorePage,
                                    //URL = $"https://www.ebay.com/sch/m.html?_nkw=&_armrs=1&_from=&_mPrRngCbx=1&_udlo={transportItem.CurrentMinPrice}&_udhi={transportItem.CurrentMaxPrice}&_ssn={pqi.Name}&_ipg=200&rt=nc",
                                    URL = pqi.URL,
                                    Name = pqi.Name,
                                });
                            }
                    ...
                    else if (!extSett.LastCheck)
                    {
                        ...
                        lock (this)
                        {
                            ...
                            {
                                ItemType = (int)ItemType.ProcessingPagePriceFilter,
                                //URL = $"https://www.ebay.com/sch/m.html?_nkw=&_armrs=1&_from=&_mPrRngCbx=1&_udlo={transportItem.CurrentMaxPrice}&_udhi=&_ssn={pqi.Name}&_ipg=200&rt=nc",
